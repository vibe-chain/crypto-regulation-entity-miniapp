...
import { Volume2, Vibrate, Bell, Shield, Info } from "lucide-react";
...
export default function SettingsScreen({ onNavigate }: SettingsScreenProps) {
  ...
  return (
    <ScreenLayout title="Settings" onNavigate={onNavigate}>
      <div className="space-y-6 text-black">
        <div>
          <h3 className="text-base font-serif font-bold mb-4">Audio & Feedback</h3>
        ...
        <div>
          <h3 className="text-base font-serif font-bold mb-4">Notifications</h3>
          <div className="flex items-center justify-between py-3 border-b border-gray-400">
            <div className="flex items-center gap-3">
              <Bell size={20} />
              <div>
